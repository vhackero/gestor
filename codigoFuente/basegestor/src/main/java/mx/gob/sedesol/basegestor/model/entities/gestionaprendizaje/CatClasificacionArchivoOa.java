...
/**
 * The persistent class for the cat_clasificacion_archivo_oa database table.
 * 
 */
@Entity
@Table(name="cat_clasificacion_archivo_oa")
@NamedQuery(name="CatClasificacionArchivoOa.findAll", query="SELECT c FROM CatClasificacionArchivoOa c")
public class CatClasificacionArchivoOa implements Serializable {
	...
	@OneToMany(mappedBy="catClasificacionArchivoOa")
	private List<TblCargaArchivosOa> cargaArchivosOas;
	
	public CatClasificacionArchivoOa() {
	}
