...
/**
 * The persistent class for the cat_status_programa database table.
 * 
 */
@Entity
@Table(name="cat_status_programa")
@NamedQuery(name="CatStatusPrograma.findAll", query="SELECT c FROM CatStatusPrograma c")
public class CatStatusPrograma implements Serializable {
...
//		tblFichaDescriptivaPrograma.setCatStatusPrograma(this);
//
...
//		tblFichaDescriptivaPrograma.setCatStatusPrograma(null);
//
//		return tblFichaDescriptivaPrograma;
//	}
