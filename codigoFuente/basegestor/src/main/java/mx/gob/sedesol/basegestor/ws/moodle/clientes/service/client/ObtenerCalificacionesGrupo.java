 ...
 * @author robert o_O
 */
public class ObtenerCalificacionesGrupo {

	private static final Logger logger = Logger.getLogger(ObtenerCalificacionesGrupo.class);
	
	private ParametroWSMoodleDTO parametroWSMoodleDTO;
	
	public ObtenerCalificacionesGrupo(ParametroWSMoodleDTO plataforma){
