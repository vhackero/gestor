 ...
 * @author robert o_O
 */
public class ObtenerCalificacionesUsuario {
	private static final Logger logger = Logger.getLogger(ObtenerCalificacionesUsuario.class);
	
	private ParametroWSMoodleDTO parametroWSMoodleDTO;
	
	public ObtenerCalificacionesUsuario(ParametroWSMoodleDTO plataforma){
		this.parametroWSMoodleDTO = plataforma;
	}
	
     public Tablas obtenerCalificacionesporUsuario(int courseid, int userid) throws ErrorWS {
