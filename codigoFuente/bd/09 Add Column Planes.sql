...
ALTER TABLE tbl_ficha_descriptiva_programa ADD CONSTRAINT fk_tbl_planes_programa FOREIGN KEY (id_plan) REFERENCES tbl_planes (id) ON DELETE NO ACTION ON UPDATE NO ACTION;