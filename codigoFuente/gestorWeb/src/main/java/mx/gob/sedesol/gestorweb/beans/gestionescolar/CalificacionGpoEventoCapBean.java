...
public class CalificacionGpoEventoCapBean extends BaseBean {
	...
	/**
	 * @param gruposXEventoCap
	 *            the gruposXEventoCap to set
	 */
	...
	/**
	 * @param eventoCapacitacionBean
	 *            the eventoCapacitacionBean to set
	 */
	...
	/**
	 * @param duracionEvento
	 *            the duracionEvento to set
	 */
	...
	/**
	 * @param tposCalificacionEc
	 *            the tposCalificacionEc to set
	 */
	 ...
	 *            the participantesByGrupo to set
	 */
	...
	/**
	 * @param muestraTblCalif
	 *            the muestraTblCalif to set
	 */
	...
	/**
	 * @param conCalifPrevias
	 *            the conCalifPrevias to set
	 */
	...
	/**
	 * @param asistenciaFacadeService
	 *            the asistenciaFacadeService to set
	 */
	...
	/**
	 * @param asistenciasPart
	 *            the asistenciasPart to set
	 */
	...
	/**
	 * @param participanteCalSel
	 *            the participanteCalSel to set
	 */
	...
	/**
	 * @param modalidadEnLinea
	 *            the modalidadEnLinea to set
	 */
