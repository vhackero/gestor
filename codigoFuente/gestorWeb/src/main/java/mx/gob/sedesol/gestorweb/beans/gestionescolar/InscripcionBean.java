...
import mx.gob.sedesol.gestorweb.exceptions.InscripcionException;
...
public class InscripcionBean extends BaseBean {
	...
	private CreditosPlanDTO creditosTotalesPlan;
	...
	private InscripcionMaxMinDTO maxMinPlan;
	...
	private List<InscripcionMateriasDTO> obtenerMateriasElectivasDeOtrosPlanes(InscripcionDTO infoPersona,
			Date fechaActual) {
	...
	private Double obtenerPorcentajeCreditosCompletados(List<InscripcionMateriasCursadasDTO> materiasCursadas,
			CreditosPlanDTO creditosTotalesPlan) {
	...
	private CreditosPlanDTO obtenerCreditosTotalesPorPlan(Long idPlan) throws InscripcionException {
	...
	private void validarInscripcionPrevia(InscripcionDTO infoPersona, Date fechaActual) throws InscripcionException {
	...
	private InscripcionMaxMinDTO validarMaximosMinimosMateriasPorPlan(InscripcionDTO infoPersona)
			throws InscripcionException {
		return inscripcionService.consultarMaxMin(infoPersona.getIdPlan())
	...
	private List<InscripcionMateriasDTO> obtenerMateriasPorPeriodoInscripcion(InscripcionDTO persona,
			Date fechaActual) {
...
//		}
	...
	public InscripcionMaxMinDTO getMaxMinPlan() {
		return maxMinPlan;
	}

	public void setMaxMinPlan(InscripcionMaxMinDTO maxMinPlan) {
	...
	public CreditosPlanDTO getCreditosTotalesPlan() {
		return creditosTotalesPlan;
	}

	public void setCreditosTotalesPlan(CreditosPlanDTO creditosTotalesPlan) {
